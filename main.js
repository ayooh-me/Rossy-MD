...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '🚩 *W E L C O M E* @user\n\nThank you for joining the group @subject' 
  conn.bye = '🚩 *G O O D B Y E*  @user\n\n Dont come back to @subject'
  conn.spromote = '🚩 *@user* you are now an admin!'
  conn.sdemote = '🚩 *@user* you are now not an admin!'
...
_quickTest()
    .then(() => conn.logger.info('🚩️ Quick Test Done , session name~> creds.json'))
    .catch(console.error)
